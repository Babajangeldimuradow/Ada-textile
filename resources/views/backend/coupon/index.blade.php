...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Kuponlar Sanawy</h6>
      <a href="{{route('coupon.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Goş</a>
    </div>
    <div class="card-body">
...
<th>Hereket</th>
          ...
          <tbody>
            @foreach($coupons as $coupon)   
                <tr>
                    ...
                    <td>
                        @if($coupon->type=='fixed')
                            {{number_format($coupon->value,2)}}TMT
                        @else
                            {{$coupon->value}}%
                        @endif</td>
                    <td>
        ...
        @else
          <h6 class="text-center">Kupon tapylmady!!! Haýyş, täze kupon dörediň</h6>
        @endif
      </div>
    </div>
</div>
