...
<div class="card">
    <h5 class="card-header">Post goşmak</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Gysgaça mazmun <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Beýany</label>
