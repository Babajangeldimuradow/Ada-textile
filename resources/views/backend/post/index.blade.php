...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Post sanawy</h6>
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>  Goş</a>
    </div>
    <div class="card-body">
...
<th>Hereket</th>
        ...
        @else
          <h6 class="text-center">Post tapylmady!!! Täze post dörediň.</h6>
        @endif
      </div>
    </div>
</div>
