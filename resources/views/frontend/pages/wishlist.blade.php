				...
				<div class="col-12">
					<div class="bread-inner">
						...
						<li><a href="{{route('home')}}">Baş sahypa<i class="ti-arrow-right"></i></a></li>
							<li class="active"><a href="javascript:void(0);">Halanlarym</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">KARTYŇYZY goşuň</th> 
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>{{$wishlist['amount']}} TMT</span></td>
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>      Sebede goş</a></td>
							...
							@else 
								<tr>
									<td class="text-center">
										Islegleriň sanawy ýok. <a href="{{route('product-grids')}}" style="color:blue;">Söwda etmegi dowam etdiriň</a>
