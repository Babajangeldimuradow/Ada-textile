                    ...
                    <div class="bread-inner">
                        <ul class="bread-list">
                          <li><a href="{{route('home')}}">Baş sahypa<i class="ti-arrow-right"></i></a></li>
                            <li class="active"><a href="blog-single.html">ÖNÜMLER</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Soňky postlar</h3>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="shop-top">
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            <label>Tertiplemek boýunça :</label>
                        ...
                        <div class="row">
                            @if(count($products)>0)
                                ...
                                @endforeach
                            @else
                                <h4 class="text-warning" style="margin:100px auto;">Önüm ýok.</h4>
                            @endif
                        </div>
                        <div class="row">
