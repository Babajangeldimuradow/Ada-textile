      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sargyt</div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
...
<th>Hereket</th>
          ...
          <tbody>
            @if(count($orders)>0)
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">Entek sargyt ýok !! Käbir önümlere sargyt etmegiňizi haýyş edýäris</h4></td>
              @endif
          </tbody>
        </table>
