...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('admin')}}" style="color:#999">Esasy</a></li>
         <li><a href="" class="active text-primary">Profil sahypasy</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="inputEmail" class="col-form-label">Emailyňyz</label>
                      ...
                      <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success btn-sm">Täzele</button>
                </form>
            </div>
        </div>
   </div>
