...
@section('title','ADA ||Düşündiriş bölümi')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Düşündiriş sanawlary</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
<th>№</th>           <!-- S.N. → № -->
<th>Awtor</th>       <!-- Author → Awtor -->
<th>Ýazgy Ady</th>   <!-- Post Title → Ýazgy Ady -->
<th>Habarlyk</th>    <!-- Message → Habarlyk / Teswir -->
<th>Sana</th>        <!-- Date → Sana -->
<th>Hal</th>         <!-- Status → Hal -->
<th>Amallar</th>     <!-- Action → Amallar -->
...
<th>Amallar</th>     <!-- Action → Amallar -->
        ...
        @else
          <h6 class="text-center">Hiç hili ýazgy teswir tapylmady !!!</h6>
        @endif
      </div>
    </div>
</div>
