...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Gysgaça düşündirişi <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Mazmuny <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="email" class="col-form-label">Emaily <span class="text-danger">*</span></label>
...
<script>
    ...
    $('#summary').summernote({
      placeholder: "Gysgaça düşündirilişi.....",
        tabsize: 2,
        height: 150
    });
    });
