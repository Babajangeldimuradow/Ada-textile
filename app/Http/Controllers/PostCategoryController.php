...
class PostCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Post kategoriýasy üstünlikli goşuldy');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Post kategoriýasy üstünlikli täzelendi');
        }
        else{
            request()->session()->flash('error','Gaýtadan synanyşyň!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Post kategoriýasy üstünlikli pozuldy');
        }
        else{
            request()->session()->flash('error','Kategoriýany pozmakda säwlik ýüze çykdy');
        }
        return redirect()->route('post-category.index');
    }
}
